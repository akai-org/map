define([], function () {
  ...
  var EditorPageCtrl = (function () {
    ...
    EditorPageCtrl.prototype.addFloor = function(buildingProperties) {
    ...
    EditorPageCtrl.prototype.saveJsonFile = function() {
    ...
    EditorPageCtrl.prototype.saveJsonFileSuccessHandler = function(response) {
    ...
    EditorPageCtrl.prototype.saveJsonFileErrorHandler = function(error) {
      console.log(error);
    }
